    ...
    void generateImage(View view) {
        try {
            ...
            if (hvp != null) {
                ...
                DrawHeartsValentine heartsValentine = new DrawHeartsValentine(tfd, hvp.getMainShape(), hvp.getShapeDetails(), hvp.getBackgroundColor(), hvp.getOuterMargin(), getContext());
